  ...
  return (
    <div className="justify-center items-center text-center">
      <div className="">
        ...
        <div className="">Hey I'm Smit Ghelani</div>
        ...
        <div className="">
          ...
          Focused on Building Scalable Infrastructures and Intelligent
          Automation
        </div>
      </div>
      <div>
      ...
      <div>
        <div>Reachout to me on,,</div>
        <div>
          <div>
            <a href="https://www.linkedin.com/in/smitghelani/">
              <i className="fa-brands fa-linkedin"></i>
            </a>
          </div>
          <div>
            <a href="https://github.com/SmitGhelani">
              <i className="fa-brands fa-github"></i>
            </a>
          </div>
          <div>
            <a href="https://x.com/smitghelani06">
