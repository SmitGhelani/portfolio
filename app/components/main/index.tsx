...
const Main = () => {
  return (
    <div id="mainpanel" className="flex flex-col rounded-lg basis-3/4 bg-gradient-to-tr from-gray-900 via-black to-gray-900 p-30 justify-center items-center text-center h-screen w-full bg-300% animate-gradient" >
