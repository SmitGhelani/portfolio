...
const SidePanel = () => {
  return (
    <div className="flex flex-col p-2 rounded-lg basis-1/4 bg-gradient-to-tr from-black via-gray-900 to-black p-30 justify-start items-center text-center h-screen w-full bg-300% animate-gradient">
