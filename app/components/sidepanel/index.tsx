...
const SidePanel = () => {
  ...
  return (
    <div id="sidebarpanel" className="sidebarpanel flex flex-col p-2 mt-2 rounded-lg p-30 mr-2 justify-start items-start text-center w-wrap bg-300% animate-gradient absolute right-1 h-[95vh] bg-gradient-animated bg-gradient-to-br from-[#3B2F2F]/[0.75] via-[#a66600]/[0.75] to-[#d09c00]/[0.75] via-[#8a663e]/[0.75]">
        <div id="sidebartogglebtn" className=" text-white font-poppins h-[80px] w-[80px] text-[36px]  animate-gradient items-center justify-center text-center mb-2 rounded-md hover:cursor-pointer bg-gradient-to-br from-[#585a3e]/[0.25] to-[#ffb949]/[0.25]" onClick={e => toggleSidebar()}><i id="shrinkbtn" className="fa-solid fa-down-left-and-up-right-to-center text-center items-center justify-center m-5"></i></div>
