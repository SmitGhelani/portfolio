...
const Project = () => {
  return (
    <div>
      <div className="p-2">
        <h1 className="flex flex-row rounded-lg bg-gradient-to-tr from-gray-900 via-black to-gray-900 p-30 justify-center items-center text-center h-20 w-full bg-300% animate-gradient text-white font-cour text-2xl">My Projects</h1>      
      </div>
      <div className="flex flex-row p-2 m-2"> 
        <div className="flex flex-row rounded-lg basis-3/4 bg-gradient-to-tr from-gray-900 via-black to-gray-900 p-30 justify-center items-center text-center h-[32rem] w-full bg-300% animate-gradient" >
