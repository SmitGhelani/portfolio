    ...
    <div style={bgImage}>
      ...
      <div className="flex flex-row p-2 m-2"> 
        <div className="flex flex-row rounded-lg basis-3/4  p-30 justify-center items-center text-center h-screen w-full bg-300% animate-gradient" >
            ...
            <Link href="https://unionboard.smitghelani.xyz/" className="text-white p-5 font-poppins object-fill w-[18rem] h-[20rem] items-center justify-center text-center m-2 rounded-xl hover:cursor-pointer bg-[#19B79D]" style={cardImgtwoStyle} >
              <div className="flex flex-row items-center justify-center text-center w-full">
